...
while($row = $sth->fetch(PDO::FETCH_ASSOC))
{
   ...
   $data .= <<< HEREDOC
     <tr align="center">
       ...
       <td><a href="edit.php?uid={$uid}" class="btn btn-warning">修改</a></td>
       <td><a href="delete.php?uid={$uid}" class="btn btn-danger" onClick="return confirm('確定要刪除嗎？');">刪除</a></td>
    </tr>
HEREDOC;
}
...
<table class="table table-hover" align="center">   
   <tr>
      ...
      <th>地址</th>
      <th>生日</th>
      <th colspan="3" align="center"><a href="add.php" class="btn btn-info">新增記錄</a></th>
   </tr>
{$data}
</table>
HEREDOC;
